...
function Header() {
  ...
  return (
    <div className='grid grid-flow-col p-2 m-2 shadow-lg'>
      ...
      <a href="/" ><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjdB5idttrtpfZkhv3Dz20jvA14SXgOCOKQiBT6_tnEyagCBi91sEJMTU8X6eLxzb5dQ&usqp=CAU" alt="youtube_logo" className='h-6 mt-1' /></a>
    </div>
    ...
    <img className='w-3/4 h-3/4' src={logo} alt="magnify_icon"  /></button>
    </div>
